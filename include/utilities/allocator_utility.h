...
class Utility {
public:
  [[nodiscard]] static void *AlignForward(void *Address,
                                          size_t Alignment) noexcept;
  [[nodiscard]] static void *AlignBackward(void *Address,
                                           size_t Alignment) noexcept;

  [[nodiscard]] static size_t GetPadding(void *Address,
                                         size_t Alignment) noexcept;
  [[nodiscard]] static size_t GetPaddingWithHeader(void *Address,
                                                   size_t Alignment,
  ...
  [[nodiscard]] static size_t PointerDifference(void *Address1,
                                                void *Address2) noexcept;
  [[nodiscard]] static size_t GetRelativeAddress(void *Address,
  ...
  [[nodiscard]] static size_t PackHandle(size_t Index,
                                         size_t Generation) noexcept;
  [[nodiscard]] static size_t UnpackHandleIndex(size_t HandleID) noexcept;
  [[nodiscard]] static size_t UnpackHandleGeneration(size_t HandleID) noexcept;
};
